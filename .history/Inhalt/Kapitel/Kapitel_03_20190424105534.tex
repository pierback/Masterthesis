...
Zudem wird der Fileserver auch für die Verwaltung der Algorithmus-Daten verwendet. Dabei wird bei jedem "Worker" Durchlauf (alle 3h) ein JSON-File erzeugt, welches folgende Keys beinhaltet: 
