...
\begin{figure}[th!]
    \centering
    \includegraphics[width=.8\columnwidth]{./Abbildungen/Kapitel_03/usr_json.png}
...
In diesen Fällen wurde das Q-Learning-Submodul des Learners gar nicht erst gestartet. \\
Besonders hier zeigte sich die Nüztlichkeit des File-Servers, da gerade in der Entwicklungsphase die Smart-Contracts häufigen Änderungen unterlagen und dahingehend sehr oft neu deployed werden mussten und somit enorm an Zeit gespart werden konnte.
