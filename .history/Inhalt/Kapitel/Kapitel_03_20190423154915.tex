...
Aufgrund von schlechten Erfahrungen mit Javascript im Bezug auf die Ethereum-Blockchain aus einem vorherigen Projekt und vor dem Hintergrund, dass das Ethereum Protokoll komplett in Golang geschrieben wurde, fiel die Wahl für diese Instanz auf diese noch relativ junge - in Anbetracht der aktuellen Versionsnummer (build version 1.12.4 - 23.04.19) - Programmiersprache.
Der Fokus lag zuerst auf Implementierung des Q-Learning Algorithmus.
