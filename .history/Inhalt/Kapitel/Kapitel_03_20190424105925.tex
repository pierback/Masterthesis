...
Zudem wird der Fileserver auch für die Verwaltung der Algorithmus-Daten verwendet. Dabei wird bei jedem "Worker" Durchlauf (alle 3h) für jeden Nutzer ein JSON-File erzeugt, welches folgende Key Value Pairs beinhaltet: 
\begin{itemize}
    \item Qt: Die aktuelle Q-Tabelle
    \item Epsilon: der aktuelle Epsilon-Wert
    \item Anzahl der falschen Predictions in der aktuellen Woche
    \item Anzahl der falschen Predictions in der aktuellen Woche
  \end{itemize}
